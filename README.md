...
2026 年全国大学生数学建模竞赛 B 题项目。7 个原始文件已归档；第一问、第二问已完成，第三问方案一已实现并通过本地闭环验证，配套中文说明、图表和论文备用资料。
...
当前完成第一问的角域直径计算、第二问的可靠约束下鲁棒选点，以及第三问方案一可执行基线。第二问结果属于经过数值核查的构造实验，不是连续全局最优证明；第三问方案一已完成本地验证，方案二保留离线设计。官方演练、正式测试和第四问按后续指示推进。
